...
class GoogleMapsScraper:
    ...
    def scrape_single_place(self, db, place_id, max_reviews=None, lat=0.0, lng=0.0, query=""):
        ...
        db.upsert_place(place, job_id=job_id)
        ...
        if max_reviews != 0:
            ...
            while ei:
                ...
                for review in reviews:
                    db.insert_review(place_id, review, job_id=job_id)
                    reviews_saved += 1
            ...
            if total_reviews > 0 or place.review_count == 0:
                db.mark_reviews_fetched(place_id, rcursor, total_reviews, job_id=job_id)
            cursor = rcursor
    ...
    def _scrape_one(self, client, db, stub, max_reviews, job_id,
        ...
        if max_reviews != 0:
            ...
            while ei:
                ...
                for review in reviews:
                    db.insert_review(pid, review, job_id=job_id)
                    reviews_saved += 1
            ...
            if reviews_saved > 0 or place.review_count == 0:
                db.mark_reviews_fetched(pid, rcursor, reviews_saved, job_id=job_id)
            cursor = rcursor
